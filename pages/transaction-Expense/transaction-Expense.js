...
function saveTransaction() {
    ...
    if (!transactionType) {
        document.getElementById('transaction-type-required-error').style.display = 'block';
        return;
    } else {
        document.getElementById('transaction-type-required-error').style.display = 'none';
    }

    if (!amountElement) {
        console.error('Elemento com ID "amount" não encontrado.');
        return;
    }
